...
>
	...
	bg-neutral-400/20 dark:text-contrast-50 text-main-400 chip group-first-of-type/tooltip:bg-{color} 
	dark:group-first-of-type/tooltip:text-{color} dark:group-first-of-type/tooltip:bg-opacity-20 group-first-of-type/tooltip:bg-opacity-50">
