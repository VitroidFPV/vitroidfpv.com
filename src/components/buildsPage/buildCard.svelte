...
{#if visible}
	<div
		class="bg-neutral-500/20 dark:bg-main-300/30 backdrop-blur-[2px] outline-2 outline outline-neutral-500/20 mt-6 w-full h-36 hover:h-96 rounded-3xl card {color} {short} shadow-[0px_-22px_0px,0px_25px_50px_-15px_#181818] duration-500 relative flex flex-col items-center group hover:delay-[0ms] delay-500">
		<div
