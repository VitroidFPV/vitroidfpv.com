<script lang="ts">
	...
	import { buildGuidePartAccentClasses } from "$lib/build-guides/theme"
...
>
	<div class="max-h-[50vh] max-w-full overflow-y-auto rounded-2xl">
		<div class="flex flex-col overflow-clip">
					...
					>
						<div class="mr-4 flex min-w-0 flex-1 flex-col gap-1">
							<h3 class="md:text-lg">
								<a
									href={item.part.url}
									class="fancy-link font-semibold {buildGuidePartAccentClasses[
										item.part.accent
									].text}"
									target="_blank"
							...
							>
								<div class="tags-scroll w-full min-w-0 overflow-x-auto">
									<PartTags
										tags={item.part.tags}
										priceClass={buildGuidePartAccentClasses[item.part.accent]
											.price}
										elevatedTooltips
						...
						>
							<div class="flex shrink-0 items-center">
								...
								<div class="ml-1 flex flex-col items-center">
									<button
										type="button"
										class="text-surface-500/40 disabled:opacity-30 {buildGuidePartAccentClasses[
											item.part.accent
										].iconHover}"
									...
									<button
										type="button"
										class="rotate-180 text-surface-500/40 disabled:opacity-30 {buildGuidePartAccentClasses[
											item.part.accent
										].iconHover}"
			...
			{/each}
			<div class="-mt-2 h-0 shrink-0 md:-mt-3"></div>
		</div>
	</div>
	<SplitCorner
