	...
	<div class="flex flex-col w-full relative">
		...
		<div class="absolute w-full h-full pointer-events-none">
			...
			<div class="absolute w-full top-20">
				<svg width="1024" height="360" viewBox="0 0 1024 360" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full -rotate-12 md:blur-3xl blur-2xl md:h-full md:scale-x-125 md:scale-y-100 scale-y-200 md:dark:saturate-100 saturate-[2] dark:opacity-70 opacity-100">
