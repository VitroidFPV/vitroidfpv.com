	...
	<ul class="mt-4">
		<li>
			<div class="flex items-center mb-4">
				...
				<div class="w-[28rem] mb-4">
					- You should be able to put this together as a complete beginner. Parts are easy to
					source, and you'll have enough space to assemble and solder everything
				</div>
			</div>
		</li>
		<li>
			<div class="flex items-center mb-4">
				...
				<div class="w-[28rem] mb-4">
					- More for intermediate pilots, or if you have more experience with electronics and
					soldering. Parts usually more expensive and sometimes hard to come across
				</div>
			</div>
		</li>
		<li>
			<div class="flex items-center">
				...
				<div class="w-[28rem] mb-4">
					- For experienced pilots that know what they're doing, this shouldn't be your first build.
					Exotic and pricy parts, tight space to build in, and other various build constraints
				</div>
			</div>
		</li>
	</ul>
